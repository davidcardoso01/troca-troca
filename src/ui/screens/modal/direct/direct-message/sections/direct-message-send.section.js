        ...
        return (
            <View style={{height: 70, justifyContent: 'center', backgroundColor: 'white'}}>
                <View style={{
                    ...
                    <TouchableOpacity onPress={() => { this.setState({...this.state, cameraVisible: true})} } style={{alignItems: 'center', justifyContent: 'center', marginLeft: 5, borderRadius: 50, width: 40, height: 40, backgroundColor: 'orange'}}>
                    ...
                    <TouchableOpacity onPress={this._onPressSent} style={{alignItems: 'center', justifyContent: 'center', marginRight: 5, marginLeft: 5, borderRadius: 50, width: 40, height: 40, backgroundColor: 'orange'}}>
